...
const ListarTarefa = () => {
  ...
  // Função para definir a cor de fundo com base no status da tarefa 
  const getStatusBackgroundColor = (status) => {
    switch (status) {
      case 'Concluída': return '#d4edda'; // Verde 
      case 'Em Andamento': return '#fff3cd'; // Amarelo 
      case 'Aguardando': return '#f8d7da'; // Vermelho 
      default: return '';
    }
  };
  ...
  return (
    <>
              ...
              <TableBody>
                {tarefas.map((row, indice) => (
                  ...
                  >
                    ...
                    <TableCell align="right">{formatDate(row.inicioTarefa)}</TableCell>
                    <TableCell align="right">{formatDate(row.fimTarefa)}</TableCell>
                    <TableCell align="center" style={{ backgroundColor: getStatusBackgroundColor(row.statusTarefa) }}>
                      {row.statusTarefa}
                    </TableCell>
      ...
      <Fab color="primary" aria-label="add" onClick={handleOpen}
        style={{ position: 'fixed', bottom: 72, right: 16, }} >
        <AddIcon />
      </Fab>
      <div>
        <Modal
